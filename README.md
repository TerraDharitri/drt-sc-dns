...
To work with unpublished numbat-wasm crates, clone https://github.com/NumbatNetwork/numbat-wasm-rs in the same parent directory and replace dependencies in Cargo.toml with:
```
numbat-wasm = { path = "../../numbat-wasm-rs/numbat-wasm" }
numbat-wasm-node = { path = "../../numbat-wasm-rs/numbat-wasm-node" }
numbat-wasm-derive = { path = "../../numbat-wasm-rs/numbat-wasm-derive" }
```

And the same for debug:
```
numbat-wasm = { path = "../../../numbat-wasm-rs/numbat-wasm" }
numbat-wasm-debug = { path = "../../../numbat-wasm-rs/numbat-wasm-debug" }
```
